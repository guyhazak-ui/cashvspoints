...
function renderSummary(summary) {
  ...
  bpLine.innerHTML = bp
    ? `<span class="summary-label points">🟢 Best Points Value</span> ${bp.airline} — ${pointsFmt(bp.points_cost)} + ${bp.taxes_display || money(bp.taxes_fees)} fees (${bp.cpp_yield ?? "—"}¢/pt) in ${CABIN_LABELS[bp.cabin] || bp.cabin}.`
  ...
  CABIN_ORDER.forEach((cabinKey) => {
    ...
    options.forEach((o) => {
      ...
      tr.innerHTML = `
        ...
        <td>${o.taxes_display || money(o.taxes_fees)}</td>
